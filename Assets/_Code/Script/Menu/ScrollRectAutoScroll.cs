...
public class ScrollRectAutoScroll : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void OnEnable()
    {
        if (m_ScrollRect)
        {
            ...
            _navigateUiInput.action.performed += HandleNavigationUpdate;
        }
    }

    private void OnDisable()
    {
        if(m_ScrollRect)_navigateUiInput.action.performed -= HandleNavigationUpdate;
    }
    ...
    void InputScroll()
    {
        if (m_Selectables.Count > 0)
        {
            ...
            if (_currentInput.x != 0f || _currentInput.y != 0f 
    ...
    private void HandleNavigationUpdate(UnityEngine.InputSystem.InputAction.CallbackContext obj)
    {
        _currentInput = obj.ReadValue<Vector2>();
    }
