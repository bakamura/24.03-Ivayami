...
{
    SerializedProperty teleportType, teleportTarget, onTeleportEnd, gizmoColor, gizmoSize;
    public override void OnInspectorGUI()
    {
        EditorGUILayout.LabelField("PARAMETERS", EditorStyles.boldLabel);
        EditorGUILayout.PropertyField(teleportType, new GUIContent("Teleport Type"));
        EditorGUILayout.PropertyField(onTeleportEnd, new GUIContent("On Teleport End"));
    ...
    private void OnEnable()
    {
        ...
        onTeleportEnd = serializedObject.FindProperty("_onTeleportEnd");
    }
}
#endif