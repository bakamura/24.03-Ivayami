...
namespace Ivayami.Enemy
{
    ...
    public class EnemyDog : StressEntity, ISoundDetection
    {
        ...
        //[SerializeField, Min(0f)] private float _soundDetectionRange;
        ...
        //                            //    _enemySounds.PlaySound(EnemySounds.SoundTypes.Chasing);
        //                            //});
        //                            PlayerStress.Instance.AddStress(_stressIncreaseOnTargetDetected, damageType: PlayerAnimation.DamageAnimation.Mental);
        //                            _isChasing = true;
        ...
        //            bool targetInsideRange = _soundDetectionRange > 0 ? Physics.OverlapSphereNonAlloc(rayOrigin, _soundDetectionRange, _hitsCache, _targetLayer, QueryTriggerInteraction.Ignore) > 0 : true;
        ...
        //            {
        //                _FOVMesh = DebugUtilities.CreateConeMesh(transform, _visionAngle, _soundDetectionRange);
